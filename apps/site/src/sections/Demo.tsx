                ...
                <div className="mt-12 grid-12">
                    <div className="col-span-12 lg:col-span-5">
                        ...
                        <p className="mt-8 max-w-md text-[15.5px] leading-[1.6] text-[var(--color-ink-dim)]">
                            The dashboard is not a chat client. It is a console: rooms on the left, the active
                            coworker in the middle, files and memory and jobs and usage around it. Everything is
                            inspectable.
                        </p>
                        <ul className="mt-10 space-y-3.5 font-mono text-[12px] tracking-tight text-[var(--color-ink-dim)]">
                            <DemoBullet>tabbed surfaces — chat, files, memory, jobs, usage</DemoBullet>
                    ...
                    <div className="col-span-12 mt-16 lg:col-span-7 lg:mt-0">
                        <div className="relative border border-[var(--color-rule)] bg-[var(--color-night-elev)] shadow-[0_40px_80px_-30px_rgba(0,0,0,0.6)]">
                            <div className="flex items-center justify-between border-b border-[var(--color-rule)] px-3 py-2">
                                ...
                                <span className="label-mono">localhost:3000 / rooms / studio-3</span>
                            ...
                            <div className="grid min-h-[460px] grid-cols-[160px_1fr]">
                                    ...
                                    <ul className="space-y-1">
                                        {sidebar.map((s, i) => (
                                            ...
                                            >
                                                ...
                                                />
                                                <span className="font-mono tracking-tight">{s}</span>
                                            </li>
                                        ))}
                                    </ul>
                                ...
                                <div className="p-5">
                                    <div className="flex items-center justify-between border-b border-[var(--color-rule)] pb-3">
                                        <div>
                                            <div className="label-mono">SESSION · MAY 22 · 14:02</div>
                                            <h3
                        ...
                        <div className="mt-3 flex items-center justify-between">
                            ...
                            <span className="label-mono">EXPORT · CSV · JSON · PROVENANCE INCLUDED</span>
                        </div>
                    </div>
                </div>
            </div>
