            ...
            <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
                <div className="grid grid-cols-12 gap-x-6 gap-y-10 py-14 lg:gap-x-10">
                    <div className="col-span-12 lg:col-span-4">
                        <div className="flex items-center gap-3 text-[var(--color-ink)]">
                            <BrandMark size={26} />
                            <span className="font-serif text-[22px] tracking-tight">Agent Room</span>
                        </div>
                        <p className="mt-5 max-w-sm text-[13.5px] leading-[1.6] text-[var(--color-ink-dim)]">
                            A self-hosted home for persistent AI coworkers. Each room is a workspace that remembers,
                            owns files, runs scheduled work, and stays on your hardware.
                        </p>
                    </div>
                    <FootCol title="PROJECT">
                        <FootLink href="https://github.com/parlali/agent_room">github</FootLink>
                        <FootLink href="https://github.com/parlali/agent_room/blob/main/README.md">readme</FootLink>
                        <FootLink href="https://github.com/parlali/agent_room/blob/main/SECURITY.md">security</FootLink>
                        <FootLink href="https://github.com/parlali/agent_room/blob/main/LICENSE">license · MIT</FootLink>
                    </FootCol>
                    <FootCol title="DOCS">
                    ...
                    <FootCol title="CONTACT">
                        <FootLink href="mailto:hello@openagentroom.com">hello@openagentroom.com</FootLink>
                        <FootLink href="https://github.com/parlali/agent_room/issues">issues</FootLink>
                        <FootLink href="https://github.com/parlali/agent_room/discussions">discussions</FootLink>
                    </FootCol>
                </div>
                ...
                <div className="flex flex-col gap-6 border-t border-[var(--color-rule)] py-6 sm:flex-row sm:items-end sm:justify-between">
                    <div className="font-mono text-[10px] uppercase leading-[1.7] tracking-[0.18em] text-[var(--color-ink-faint)]">
                        <div>© {new Date().getFullYear()} agent room project · mit license · made with open primitives</div>
