                ...
                <div className="grid-12">
                    <div className="col-span-12 lg:col-span-7">
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="label-mono text-[var(--color-accent)]">FILE 01 OF 07</span>
                        </div>
                        ...
                        >
                            <span
                                ...
                                style={{ animation: 'reveal-up 1s cubic-bezier(0.16, 1, 0.3, 1) 0.05s forwards' }}
                            >
                                Self-hosted
                            </span>
                            <span
                                className="block opacity-0"
                                style={{ animation: 'reveal-up 1s cubic-bezier(0.16, 1, 0.3, 1) 0.18s forwards' }}
                            >
                                rooms for{' '}
                                <em
                            ...
                            <span
                                className="block opacity-0"
                                style={{ animation: 'reveal-up 1s cubic-bezier(0.16, 1, 0.3, 1) 0.32s forwards' }}
                            >
                                AI{' '}
                                <em
                                    className="font-serif-italic text-[var(--color-quote)]"
                        ...
                        <p
                            ...
                            style={{ animation: 'reveal-up 1s cubic-bezier(0.16, 1, 0.3, 1) 0.55s forwards' }}
                        >
                            Every other agent forgets you the second the chat closes. A room remembers.
                            <br />
                            <br />
                            Each room is one standalone coworker with its own filesystem, structured memory, scheduled
                            jobs, tools, MCP bindings, provider identity, and audit trail. Boot the whole thing with one
                            Docker command on your own machine.
                        </p>

                        <div
                            className="mt-12 flex flex-wrap items-center gap-x-8 gap-y-5 opacity-0"
                            style={{ animation: 'reveal-up 1s cubic-bezier(0.16, 1, 0.3, 1) 0.7s forwards' }}
                        >
                            <MarqueeLink
                    ...
                    <div className="col-span-12 mt-16 lg:col-span-5 lg:mt-0">
                        <div className="lg:sticky lg:top-24">
                            <div
                                className="opacity-0"
                                style={{ animation: 'reveal-up 1.2s cubic-bezier(0.16, 1, 0.3, 1) 0.45s forwards' }}
                            >
                                <div className="mb-3 flex items-center justify-between">
                                    <span className="label-mono">LIVE ROOM · SAMPLE TRANSCRIPT</span>
