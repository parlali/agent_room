                ...
                <div className="mt-16 grid-12">
                    ...
                    <div className="col-span-12 lg:col-span-6 lg:col-start-7">
                        <p className="text-[16.5px] leading-[1.65] text-[var(--color-ink-dim)] sm:text-[17.5px]">
                            They live for one session. They forget you the moment the tab closes.
                            They share memory with every other thread the same user opens. They run
                            inside someone else&rsquo;s cloud, with credentials, files, and prompts
                            mingled across customers.
                        </p>
                        <p className="mt-7 text-[16.5px] leading-[1.65] text-[var(--color-ink-dim)] sm:text-[17.5px]">
                            A room is the opposite shape. It is one coworker, in one bounded
                            workspace, on your machine. Files stay in the room. Memory belongs to
                            the room. Jobs run inside the room. Provider keys never leave the room.
