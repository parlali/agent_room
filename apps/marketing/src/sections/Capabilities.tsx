                ...
                <div className="mt-12 grid-12">
                    ...
                    <div className="col-span-12 lg:col-span-4 lg:pt-3">
                        <p className="text-[15.5px] leading-[1.6] text-[var(--color-ink-dim)]">
                            The list of what a room can do is short, deliberate, and oriented around
                            the kinds of work an actual coworker takes off your plate. Nothing here
                            is &ldquo;coming soon.&rdquo;
                        </p>
                    </div>
                </div>
    ...
    return (
        <article className="group grid grid-cols-12 gap-x-6 border-b border-[var(--color-rule)] py-8 transition lg:gap-x-10 lg:py-10">
            ...
            <div className="col-span-12 sm:col-span-4 lg:col-span-2">
                <div className="label-mono mt-1.5 text-right text-[var(--color-ink-faint)]">
                    SPEC
                </div>
