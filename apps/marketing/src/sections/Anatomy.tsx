                ...
                <div className="mt-12 grid-12">
                    <div className="col-span-12 lg:col-span-5">
                        ...
                        <p className="mt-8 max-w-md text-[15.5px] leading-[1.6] text-[var(--color-ink-dim)]">
                            A room is not a chat window with extras bolted on. Every part is
                            isolated to its room and survives restarts. You can open ten rooms; they
                            will share nothing.
                        </p>
...
function PartCell({
    ...
    return (
        <div className="group relative bg-[var(--color-night)] p-6 transition hover:bg-[var(--color-night-elev)] sm:p-7">
            ...
            <div className="mt-5 font-mono text-[11px] tracking-[0.18em] text-[var(--color-accent)]">
                {part.title}
            </div>
            <div
