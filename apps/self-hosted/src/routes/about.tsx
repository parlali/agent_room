            ...
            <div className="space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Agent Room runs on your machine and turns provider models into durable
                            workspaces. The important unit is not a one-off chat; it is a room with
                            its own runtime, memory, files, jobs, and audit trail.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-4 text-sm text-muted-foreground md:grid-cols-[1.1fr_0.9fr]">
                        <div className="space-y-3">
                            <p>
                                Use rooms for recurring work: a product room, a research room, an
                                ops room, a customer account room, or any long-lived context where
                                continuity matters.
                            </p>
                            <p>
